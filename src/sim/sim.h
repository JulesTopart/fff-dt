...
public:
	...
	glm::vec3 getBunnyPosition() const { return animationBunny(elapsedTime); }
	Mesh_Ptr getBunny() { return obstacle; }

private:
	glm::vec3 animationBunny(float time) const;
